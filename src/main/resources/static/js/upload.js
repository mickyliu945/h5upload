(function($){
    $.fn.ajaxImageUpload = function(options){
        ...
        var ajaxUpload = function () {
            ...
            // 获取最新的
            var imageSection = $('.image-section:last');
        ...
        var createDeleteModal = function () {
            ...
            $(".confirm-btn").click(function(){
                // 执行成功回调函数
                var src = deleteImageSection.find('img').attr("src");
        ...
        var createImageSection = function () {
            ...
            imageSection.insertBefore($('.upload-section'));
...
function initPics(imgArr) {
    $.each(imgArr, function(index, value) {
        var item = $('<section class="image-section">'
        + '<div class="image-shade"></div>'
        + '<div class="image-delete"></div>'
        + '<div class="image-zoom"></div>'
        + '<img class="image-show" src="' + value + '" />'
        + '<input id="src" name="src" value="" type="hidden" />'
        + '</section>');
        item.insertBefore($('.upload-section'));
    })
}